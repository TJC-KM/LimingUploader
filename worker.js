...
2. 工作欄位為「-」或空白則忽略
3. 表格中工作 C領會 D翻譯 E領詩 F司琴 G和H是接待 I車管 J視聽 K禱告 
4. 其他工作 聚會類型(唱詩禱告會:[主領] 真理分享會:[主領][主領] 見證會:[主領] 查經聚會帶領:[查經人員][查經人員][查經人員][查經人員] 唱詩禱告會:[主領]
5. 其他工作 安息日讀經、安息日午餐悟性禱告、愛餐清潔
6. 姓名保留原始文字，不要增刪
7. 只輸出 JSON 陣列，不要任何說明文字或 markdown 標記
